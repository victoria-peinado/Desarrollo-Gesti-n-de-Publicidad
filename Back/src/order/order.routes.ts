...
import { findAll, findOne, add, update, remove,sanitizeOrderInput, findWithRelations, testRenovarOrdenes, cancelOrder,  } from "./order.controler.js";
import { validateWithSchema , validateObjectId, validateCuit,validateIdExistence} from '../shared/db/middleware.js'
import { CancelOrderSchema, OrderSchema, PatchOrderSchema, PutOrderSchema} from './order.entity.js'
...
//orderRouter.put('/cancelOrder/:id', validateWithSchema(CancelOrderSchema), validateObjectId('id'), cancelOrder)
orderRouter.put('/cancelOrder/:id', sanitizeOrderInput, cancelOrder)
