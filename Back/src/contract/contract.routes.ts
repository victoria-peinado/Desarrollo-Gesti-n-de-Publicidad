...
contractRouter.get('/shop/:idShop',verifyToken, authorizeUserRoles('admin'), validateObjectId('idShop'), getByShop) // Validate shop ID for finding contracts by shop ID
